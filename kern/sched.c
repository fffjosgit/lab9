...
//хороший шанс, что не уложимся в дедлайн
//если два реал-тайм процесса работают по очереди, никто больше не получит управление
//(даже тот, кто хочет стать реал-тайм процессом)
